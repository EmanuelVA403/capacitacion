			...
			<div class="panel-body">
				<form class="bs-example form-horizontal" action="" method="post">
					...
					<div class="form-group text-right">
						<div class="col-lg-12"> 
							<button type="submit" class="fa fa-folder-open-o"><i class="fa fa-folder-open-o"></i> Agregar</button>
							<a href="admin.php?m=clientes" class="fa fa-folder-open-o"><i class="fa fa-times icon"></i> Cancelar</a>
						</div>
					</div>
				</form>
			</div>
